...
[babylon](../../../../README.md) / [lib/errors/domain.errors](../README.md) / WithdrawalError

# Class: WithdrawalError

Defined in: [src/lib/errors/domain.errors.ts:210](https://github.com/lalalune/babylon/blob/309d41be44719cd3238d25a6c463d399f70ddf34/src/lib/errors/domain.errors.ts#L210)
...
> **new WithdrawalError**(`message`, `withdrawalId`, `reason`): `WithdrawalError`

Defined in: [src/lib/errors/domain.errors.ts:211](https://github.com/lalalune/babylon/blob/309d41be44719cd3238d25a6c463d399f70ddf34/src/lib/errors/domain.errors.ts#L211)
...
`"INSUFFICIENT_BALANCE"` | `"PENDING_TRADES"` | `"COOLDOWN"` | `"ALREADY_PROCESSED"` | `"INVALID_AMOUNT"`
...
Defined in: [src/lib/errors/domain.errors.ts:213](https://github.com/lalalune/babylon/blob/309d41be44719cd3238d25a6c463d399f70ddf34/src/lib/errors/domain.errors.ts#L213)

***

### reason

> `readonly` **reason**: `"INSUFFICIENT_BALANCE"` \| `"PENDING_TRADES"` \| `"COOLDOWN"` \| `"ALREADY_PROCESSED"` \| `"INVALID_AMOUNT"`

Defined in: [src/lib/errors/domain.errors.ts:214](https://github.com/lalalune/babylon/blob/309d41be44719cd3238d25a6c463d399f70ddf34/src/lib/errors/domain.errors.ts#L214)
